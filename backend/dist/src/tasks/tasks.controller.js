...
let TasksController = class TasksController {
    ...
    findByPriority(priority) {
        return this.tasksService.findTasksByPriority(priority);
    }
    findByAssignee(assignedTo) {
        return this.tasksService.findTasksByAssignee(assignedTo);
    }
    findOne(id) {
...
__decorate([
    (0, common_1.Get)('assignee/:assignedTo'),
